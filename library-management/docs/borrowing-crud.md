...
flowchart TD
  ...
  Create -->|Yes| CreateAction[Create borrowing record\n(POST /borrowings)] --> Decision1
  Create -->|No| Read{Read ?}
  ...
  Update -->|Yes| UpdateAction[Update record\n(PUT /borrowings/:id)] --> Decision2
  Update -->|No| Delete{Delete ?}

  Delete -->|Yes| DeleteAction[Delete record\n(DELETE /borrowings/:id)] --> Decision2
  Delete -->|No| Decision2
